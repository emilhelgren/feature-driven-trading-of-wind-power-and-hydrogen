...
for i in 12:12
    ...
    filename = "2020/comparing_architecture/MEDIUM_ORACLE"
...
for i in 12:12
    ...
    filename = "2020/comparing_architecture/MEDIUM_forecast_model_ORACLE"
    easy_export(data, names, filename,)
end
...
for i in 12:12
    ...
    filename = "2020/comparing_architecture/MEDIUM_fp_ORACLE"
    easy_export(data, names, filename,)
end
