...
qFs = DataFrame(CSV.File("./results/2020/pricedomains/medium_PRICEDOMAIN_mo12.csv"))
...
for i in 12:12
    ...
    filename = "2020/pricedomains/medium_PRICEDOMAIN_mo$(n_months)_opt_adj"
...
#     filename = "2020/pricedomains/medium_forecast_model_PRICEDOMAIN_mo$n_months"
#     easy_export(data, names, filename,)
# end
...
#     filename = "2020/pricedomains/medium_fp_PRICEDOMAIN_mo$n_months"
#     easy_export(data, names, filename,)
# end
