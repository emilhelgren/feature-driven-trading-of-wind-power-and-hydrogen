...
for i in 12:12
    ...
    filename = "2020/pricedomains/medium_pricedomain_ORACLE"
...
for i in 12:12
    ...
    filename = "2020/pricedomains/medium_forecast_model_pricedomain_ORACLE"
    easy_export(data, names, filename,)
end
...
for i in 12:12
    ...
    filename = "2020/pricedomains/medium_fp_pricedomain_ORACLE"
    easy_export(data, names, filename,)
end
