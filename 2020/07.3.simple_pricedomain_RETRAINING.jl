...
for i in 1:12
    ...
    for v in 1:(validation_period+test_period)
        ...
        if (v % (720) == 0)
            ...
            filename = "2020/changing_qs_simple/$(n_months)_month_training/simple_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
...
#             filename = "2020/changing_qs_simple/$(n_months)_month_training/simple_forecasted_model_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
#             easy_export(data, names, filename,)
...
#             filename = "2020/changing_qs_simple/$(n_months)_month_training/simple_fp_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
#             easy_export(data, names, filename,)
