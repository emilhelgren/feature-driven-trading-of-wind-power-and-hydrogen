...
for i in 1:12
    ...
    filename = "2020_red_elec/pricedomains/simple_PRICEDOMAIN_mo$n_months"
...
for i in 1:12
    ...
    filename = "2020_red_elec/pricedomains/simple_forecast_model_PRICEDOMAIN_mo$n_months"
    easy_export(data, names, filename,)
end
...
for i in 1:12
    ...
    filename = "2020_red_elec/pricedomains/simple_fp_PRICEDOMAIN_mo$n_months"
    easy_export(data, names, filename,)
end
