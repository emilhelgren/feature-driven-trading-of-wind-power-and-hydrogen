...
#     filename = "2022/comparing_architecture/SIMPLE_mo$n_months"
...
for i in 1:3
    ...
    filename = "2022/comparing_architecture/SIMPLE_forecast_model_mo$n_months"
    easy_export(data, names, filename,)
end
...
#     filename = "2022/comparing_architecture/SIMPLE_fp_mo$n_months"
#     easy_export(data, names, filename,)
# end
