...
#             filename = "2022/changing_qs_medium/$(n_months)_month_training/medium_forecast_model_pricedomain_RETRAINING_we$(Int(round(v/168)))"
#             easy_export(data, names, filename,)
...
for i in 1:3
    ...
    for v in 1:(validation_period+test_period)
        ...
        if (v % (168) == 0)
            ...
            filename = "2022/changing_qs_medium/$(n_months)_month_training/medium_fp_pricedomain_RETRAINING_we$(Int(round(v/168)))"
            easy_export(data, names, filename,)
