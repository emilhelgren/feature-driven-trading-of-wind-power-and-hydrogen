...
qFs = DataFrame(CSV.File("./results/2020_red_elec/pricedomains/hourly_PRICEDOMAIN_mo12.csv"))
...
for i in 12:12
    ...
    filename = "2020_red_elec/pricedomains/hourly_PRICEDOMAIN_mo$(n_months)_opt_adj"
...
#     filename = "2020_red_elec/pricedomains/hourly_forecast_model_PRICEDOMAIN_mo$n_months"
#     easy_export(data, names, filename,)
# end
...
#     filename = "2020_red_elec/pricedomains/hourly_rf_PRICEDOMAIN_mo$n_months"
#     easy_export(data, names, filename,)
# end
