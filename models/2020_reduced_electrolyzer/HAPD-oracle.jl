...
for i in 12:12
    ...
    filename = "2020_red_elec/pricedomains/hourly_pricedomain_ORACLE"
...
for i in 12:12
    ...
    filename = "2020_red_elec/pricedomains/hourly_forecast_model_pricedomain_ORACLE"
    easy_export(data, names, filename,)
end
...
for i in 12:12
    ...
    filename = "2020_red_elec/pricedomains/hourly_rf_pricedomain_ORACLE"
    easy_export(data, names, filename,)
end
