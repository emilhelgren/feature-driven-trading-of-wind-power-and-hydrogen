...
for i in 1:1
    ...
    for v in 1:(validation_period+test_period)
        ...
        if (v % (720) == 0)
            ...
            filename = "2022/changing_qs_general/$(n_months)_month_training/general_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
...
#             filename = "2022/changing_qs_general/$(n_months)_month_training/general_forecasted_model_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
#             easy_export(data, names, filename,)
...
#             filename = "2022/changing_qs_general/$(n_months)_month_training/general_rf_pricedomain_RETRAINING_mo$(Int(round(v/720)))"
#             easy_export(data, names, filename,)
