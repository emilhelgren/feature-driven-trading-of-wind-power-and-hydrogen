...
#             filename = "2022/changing_qs_hourly/$(n_months)_month_training/hourly_RETRAINING_mo$(Int(round(v/720)))"
...
#             filename = "2022/changing_qs_hourly/$(n_months)_month_training/hourly_forecast_model_RETRAINING_mo$(Int(round(v/720)))"
#             easy_export(data, names, filename,)
...
for i in 1:3
    ...
    for v in 1:(validation_period+test_period)
        ...
        if (v % (720) == 0)
            ...
            filename = "2022/changing_qs_hourly/$(n_months)_month_training/hourly_rf_RETRAINING_mo$(Int(round(v/720)))"
            easy_export(data, names, filename,)
